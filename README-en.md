...
Workflow for scraping, AI parsing and creating web pages for Historical Newspapers.

[![final web](/img/output.png)](https://rafav.github.io/diariomercantil/1807/index.html)

# 1. Introduction.

This article details the process of using AI for automatic location and identification of literary, artistic, and cultural news, with special attention to the Golden Age, in 19th-century press examples. This computational procedure, applicable to other newspapers, has resulted in a reduction of %[to be determined] of the time needed to locate data manually. Additionally, it has been statistically validated, which has allowed researchers to accept the results of AI queries. Finally, it details the deliverables that are automatically generated with the located information.
